...
#cat $1 | xargs -I{fileID} sh -c "diamond blastx -d /home/DATABASES/PATRIC/PATRIC_VF -q $2/P03_map_HG/polished_{fileID}.fasta -a $2/P04_custom_dbs/{fileID}_vs_patric -p $3 -t $2/P04_custom_dbs/temp"
#cat $1 | xargs -I{fileID} sh -c "diamond view -a $2/P04_custom_dbs/{fileID}_vs_patric.daa -o $2/P04_custom_dbs/{fileID}_vs_patric.m8"
#cat $1 | xargs -I{fileID} sh -c "perl /home/acobian/bin/MYSCRIPTS/besthitblast.pl $2/P04_custom_dbs/{fileID}_vs_patric.m8 > $2/P04_custom_dbs/besthit_{fileID}_vs_patric.m8"
#cat $1 | xargs -I{fileID} sh -c "cut -f 1,2 $2/P04_custom_dbs/besthit_{fileID}_vs_patric.m8  | sort | uniq | cut -f2 | sort | uniq -c | sort -nr  | sed -e 's/^ *//' | tr ' ' '\t'  > $2/P04_custom_dbs/hits_virulencefactors_{fileID}.tab"
#cat $1 | xargs -I{fileID} sh -c "cut -f 2 $2/P04_custom_dbs/hits_virulencefactors_{fileID}.tab | cut -d '|' -f 2 | xargs -I{ID2} grep {ID2} /home/DATABASES/PATRIC/PATRIC_VF.faa > $2/mg/P04_custom_dbs/names_hits_virulencefactors_{fileID}.tab"
#cat $1 | xargs -I{fileID} sh -c "paste $2/P04_custom_dbs/hits_virulencefactors_{fileID}.tab $2/P04_custom_dbs/names_hits_virulencefactors_{fileID}.tab > $2/P04_custom_dbs/OUT_virulencefactors_hits_and_names_{fileID}.tab"
...
#cat $1 | xargs -I{fileID} sh -c 'diamond blastx -d /home/DATABASES/PATRIC/CARD -q /home/acobian/DH08102018/mg/P03_map_HG/polished_{fileID}.fasta -a /home/acobian/DH08102018/mg/P04_custom_dbs/{fileID}_vs_CARD -p 40 -t /home/acobian/DH08102018/mg/P04_custom_dbs/temp'
#cat $1 | xargs -I{fileID} sh -c 'diamond view -a /home/acobian/DH08102018/mg/P04_custom_dbs/{fileID}_vs_CARD.daa -o /home/acobian/DH08102018/mg/P04_custom_dbs/{fileID}_vs_CARD.m8'
#cat $1 | xargs -I{fileID} sh -c 'perl /home/acobian/bin/MYSCRIPTS/besthitblast.pl /home/acobian/DH08102018/mg/P04_custom_dbs/{fileID}_vs_CARD.m8 > /home/acobian/DH08102018/mg/P04_custom_dbs/besthit_{fileID}_vs_CARD.m8'
#cat $1 | xargs -I{fileID} sh -c 'cut -f 1,2 /home/acobian/DH08102018/mg/P04_custom_dbs/besthit_{fileID}_vs_CARD.m8  | sort | uniq | cut -f2 | sort | uniq -c | sort -nr  | sed -e "s/^ *//" | tr " " "\t"  > /home/acobian/DH08102018/mg/P04_custom_dbs/hits_CARD_{fileID}.tab'
#cat $1 | xargs -I{fileID} sh -c 'cut -f 2 /home/acobian/DH08102018/mg/P04_custom_dbs/hits_CARD_{fileID}.tab | cut -d '"'"'|'"'"' -f 2 | xargs -I{ID2} grep {ID2} /home/DATABASES/PATRIC/CARD.faa > /home/acobian/DH08102018/mg/P04_custom_dbs/names_hits_CARD_{fileID}.tab'
#cat $1 | xargs -I{fileID} sh -c 'paste /home/acobian/DH08102018/mg/P04_custom_dbs/hits_CARD_{fileID}.tab /home/acobian/DH08102018/mg/P04_custom_dbs/names_hits_CARD_{fileID}.tab > /home/acobian/DH08102018/mg/P04_custom_dbs/OUT_CARD_hits_and_names_{fileID}.tab'

#diamond:Human_pathogenic_bacterial_exotoxin
#rm -r /home/acobian/DH08102018/mg/P04_custom_dbs/temp
#mkdir /home/acobian/DH08102018/mg/P04_custom_dbs/temp

#cat $1 | xargs -I{fileID} sh -c 'diamond blastx -d /home/DATABASES/CustomDBS/Human_pathogenic_bacterial_exotoxin -q /home/acobian/DH08102018/mg/P03_map_HG/polished_{fileID}.fasta -a /home/acobian/DH08102018/mg/P04_custom_dbs/{fileID}_vs_exotoxin -p 20 -t temp'
#cat $1 | xargs -I{fileID} sh -c 'diamond view -a /home/acobian/DH08102018/mg/P04_custom_dbs/{fileID}_vs_exotoxin.daa -o /home/acobian/DH08102018/mg/P04_custom_dbs/{fileID}_vs_exotoxin.m8'
#cat $1 | xargs -I{fileID} sh -c 'perl /home/acobian/bin/MYSCRIPTS/besthitblast.pl /home/acobian/DH08102018/mg/P04_custom_dbs/{fileID}_vs_exotoxin.m8 > /home/acobian/DH08102018/mg/P04_custom_dbs/besthit_{fileID}_vs_exotoxin.m8'
#cat $1 | xargs -I{fileID} sh -c 'cut -f 1,2 /home/acobian/DH08102018/mg/P04_custom_dbs/besthit_{fileID}_vs_exotoxin.m8  | sort | uniq | cut -f2 | sort | uniq -c | sort -nr  | sed -e "s/^ *//" | tr " " "\t"  > /home/acobian/DH08102018/mg/P04_custom_dbs/hits_exotoxin_{fileID}.tab'
#cat $1 | xargs -I{fileID} sh -c 'cut -f 2 /home/acobian/DH08102018/mg/P04_custom_dbs/hits_exotoxin_{fileID}.tab | cut -d '"'"'|'"'"' -f 2 | xargs -I{ID2} grep {ID2} /home/DATABASES/CustomDBS/Human_pathogenic_bacterial_exotoxin.faa > /home/acobian/DH08102018/mg/P04_custom_dbs/names_hits_exotoxin_{fileID}.tab'
#cat $1 | xargs -I{fileID} sh -c 'paste /home/acobian/DH08102018/mg/P04_custom_dbs/hits_exotoxin_{fileID}.tab /home/acobian/DH08102018/mg/P04_custom_dbs/names_hits_exotoxin_{fileID}.tab > /home/acobian/DH08102018/mg/P04_custom_dbs/OUT_exotoxin_hits_and_names_{fileID}.tab'
...
#cat $1 | xargs -I{fileID} sh -c 'grep '"'"'Viruses'"'"'  /home/acobian/DH08102018/mg/P06_blastn_nt/besthit_vs_NT_{fileID}.blastn | cut -f 12 | sort -nr | uniq -c | sort -nr | sed -e "s/^ *//" | tr " " "\t" > /home/acobian/DH08102018/mg/P06_blastn_nt/count_viral_hits_{fileID}.tab'
#cat $1 | xargs -I{fileID} sh -c 'grep '"'"'Bacteria'"'"'  /home/acobian/DH08102018/mg/P06_blastn_nt/besthit_vs_NT_{fileID}.blastn | cut -f 12 | sort -nr | uniq -c | sort -nr | sed -e "s/^ *//" | tr " " "\t" > /home/acobian/DH08102018/mg/P06_blastn_nt/count_species_bacteria_hits_{fileID}.tab'
#cat $1 | xargs -I{fileID} sh -c 'grep '"'"'Eukaryota'"'"'  /home/acobian/DH08102018/mg/P06_blastn_nt/besthit_vs_NT_{fileID}.blastn | cut -f 12 | sort -nr | uniq -c | sort -nr | sed -e "s/^ *//" | tr " " "\t" > /home/acobian/DH08102018/mg/P06_blastn_nt/count_eukaryota_hits_{fileID}.tab'
#cat $1 | xargs -I{fileID} sh -c 'grep '"'"'Bacteria'"'"'  /home/acobian/DH08102018/mg/P06_blastn_nt/besthit_vs_NT_{fileID}.blastn | cut -f 12 | cut -f 1 -d "'" "'" | sort -nr | uniq -c | sort -nr | sed -e "s/^ *//" | tr " " "\t" > /home/acobian/DH08102018/mg/P06_blastn_nt/count_genus_bacteria_hits_{fileID}.tab'
